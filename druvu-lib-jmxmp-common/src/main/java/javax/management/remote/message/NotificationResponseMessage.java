 ...
 *
 * <p>This message is sent from a server to a client in response to a previous {@link NotificationRequestMessage} from
 * the client.
 */
public class NotificationResponseMessage implements Message {
     ...
     * @throws NullPointerException if <code>wrappedNotificationResult</code> is null.
     */
    ...
    /**
     * @serial Notifications returned to the caller. This is a {@link NotificationResult} object wrapped using the
     *     {@link ObjectWrapping} for the connection using this message.
     */
