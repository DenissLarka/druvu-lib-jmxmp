 ...
 * {@link GenericConnectorServer#MESSAGE_CONNECTION_SERVER} in the <code>Map</code> passed to its constructor.
 */
public interface MessageConnectionServer {
     ...
     *     clean up the server's resources. The caller will not call {@link #accept} after <code>stop()</code>, whether
     *     or not it gets <code>IOException</code>.
     */
