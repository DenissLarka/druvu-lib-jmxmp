...
public interface ClientAdmin {
    /**
     * Tells that a transport connection has been established and an implementation of this method is called to verify
     * this connection, for example, to do authentication, to add a encription level to secure the connection etc.
     *
