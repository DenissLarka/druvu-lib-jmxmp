 ...
 *
 * <p>When the {@link #combine} method is called the {@link ProtectionDomain} is augmented with the permissions granted
 * to the set of principals present in the supplied {@link Subject}.
 */
