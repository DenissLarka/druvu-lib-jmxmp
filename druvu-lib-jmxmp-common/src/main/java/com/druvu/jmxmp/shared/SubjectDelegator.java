...
import com.druvu.jmxmp.util.CacheMap;
...
public class SubjectDelegator {
    ...
    public synchronized AccessControlContext delegatedContext(
            AccessControlContext authenticatedACC, Subject delegatedSubject) throws SecurityException {
