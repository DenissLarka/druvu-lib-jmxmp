 ...
 *
 * <p>Each profile is created by an instance of {@link ProfileClientProvider}. This instance is found as follows.
 * Suppose the given <code><em>profile</em></code> looks like <code>TLS</code>. Then the factory will attempt to find
 * the appropriate {@link ProfileClientProvider} for <code><em>tls</em></code>. Suppose the given <code><em>profile</em>
 * </code> looks like <code>SASL/PLAIN</code>. Then the factory will attempt to find the appropriate
 * {@link ProfileClientProvider} for <code><em>sasl</em></code>. The <code><em>profile</em></code> string passed in to
 ...
 * parameter, the class loader that loaded the <code>ProfileClientFactory</code> class is used.
 *
 ...
 * {@link ProfileClientProvider#createProfile(String, Map) createProfile} on the provider.
 *
 * <p>The <code>Map</code> parameter passed to the <code>ProfileClientProvider</code> is a new read-only copy of the
 * <code>environment</code> parameter to {@link #createProfile(String, Map) ProfileClientFactory.createProfile}, or an
 ...
 * associated value is the class loader that loaded the <code>ProfileClientFactory</code> class.
 */
public class ProfileClientFactory {
    ...
    private static final String PROFILE_PROVIDER_DEFAULT_PACKAGE = "com.druvu.jmxmp.client.profile";
    ...
    private static ProfileClientProvider getProvider(String profile, String pkgs, ClassLoader loader)
        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            if (!(obj instanceof ProfileClientProvider)) {
                final String msg = "Provider not an instance of " + ProfileClientProvider.class.getName() + ": "
